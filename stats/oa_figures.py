"""
OA Three Energy Surfaces: Publication-Ready Figures.

OA-level version of lsoa_figures.py. Identical analytical framework
at ~5x finer spatial resolution (~130 households per OA).

Usage:
    uv run python stats/oa_figures.py
    uv run python stats/oa_figures.py canterbury
    uv run python stats/oa_figures.py manchester bristol york
"""
...
from proof_of_concept_oa import (  # noqa: E402
...
FIGURE_DIR = PROJECT_DIR / "stats" / "figures" / "oa"
