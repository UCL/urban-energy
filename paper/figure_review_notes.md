...
The current set is twelve figures in `paper/figures/`, built by `stats/argument_figures.py`
(F1–F8, F11 forest, F12 equity) and `stats/map_figures.py` (F9–F10), styled through `stats/figstyle.py`.
