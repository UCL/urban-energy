...
**Access, and the rate.** The accessibility axis is both supported by and extends the literature. Ewing et al. (2018) argue that low car-use in compact areas is explained by regional accessibility rather than density as such, and Elldér et al. (2022) demonstrate that local amenity access encourages residents to remain local and travel less; the present finding of a roughly twenty-seven-fold on-foot accessibility advantage for flatted neighbourhoods operationalises that mechanism at national scale over the road network. The access-per-energy rate has one near relative: the mobility energy productivity metric of Hou et al. (2019), a composite score of opportunities reachable per unit of time, cost and energy, built from modelled travel times and mode energy-intensity parameters as a planning tool for United States locations. The rate here differs in being an empirical national contrast rather than a location score: it is computed from metered household energy and survey-anchored car energy for the full national stock of output areas, read between dwelling forms, and held under decarbonisation scenarios. That specific quantification, everyday access reachable per kilowatt-hour actually spent, remains without precedent, and is consistent with the accessibility-centred turn in the transport literature.
