...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{fig12_equity}
\caption{\textbf{The deprivation gradient of walkable access.} Left: median everyday amenities within a 1.6\,km walk by income-deprivation decile of the Indices of Deprivation 2025; nationally, the most deprived decile holds about \nepiimdAccessRatio$\times$ the walkable access of the least deprived. Right: the rank correlation between walkable access and income deprivation by stratum. The national gradient (\nepiimdRhoNat) flattens in inner London (\nepiimdRhoInner) and inverts in Manchester (\nepiimdRhoManchester) and Bristol (\nepiimdRhoBristol), where the least deprived areas hold the highest-access cores.}
\label{edfig:equity}
\end{figure}
